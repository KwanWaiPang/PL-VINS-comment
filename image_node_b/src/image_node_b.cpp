...
int main(int argc, char **argv) {
  ...
  m_camera = camodocal::CameraFactory::instance()->generateCameraFromYamlFile("/home/kwanwaipang/catkin_ws/src/PL-VINS/config/euroc/euroc_config_fix_extrinsic.yaml");//路径要注意
  ...
  message_filters::Subscriber<sensor_msgs::Image> image_sub(nh, "/davis346/image_raw_grey", 1000);
